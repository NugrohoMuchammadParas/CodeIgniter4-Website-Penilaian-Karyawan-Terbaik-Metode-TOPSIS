        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="admin-karyawan-tambah-data" method="POST" id="formInput" autocomplete="off">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('alamat') ? 'has-error has-feedback' : ''); ?>">
                                        ...
                                        <textarea class="form-control" placeholder="Input Data......" id="alamat" name="alamat" rows="5"></textarea>
