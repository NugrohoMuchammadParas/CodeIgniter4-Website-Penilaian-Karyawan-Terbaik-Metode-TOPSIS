          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-8 col-8 ps-xl-0 ps-lg-0 ps-md-0 ps-sm-0 ps-xs-0">
            <div class="card-pricing2 card-black shadow">
              ...
              <div class="price-value mb-4">
                <div class="value">
                  <span class="amount">Regist</span>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-8 offset-2 bg-black rounded shadow">
                  <form action="register-data" method="POST" id="formInput" autocomplete="off">
                    <?= csrf_field() ?>
                    ...
                    <br>
                    <button type="button" id="simpan_tambah" class="btn btn-sm btn-info btn-rounded w-75 fw-bold mb-1">Simpan</button>
                    <hr style="color:white;">
                    <button type="button" id="kembali" data-pages="<?= $kembali; ?>" class="btn btn-sm btn-info btn-rounded w-75 fw-bold mb-1 mt-1">Kembali</button>
                    <hr style="color:white;">
                  </form>
                </div>
              </div>
